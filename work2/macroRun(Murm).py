...
#копирование данных для  участка заправки и сливы #ЗАПИХНУТЬ  В ФУНКЦИЮ
xl = win32com.client.Dispatch("Excel.Application")
wb = xl.Workbooks.Open("C:\\Users\\Dmitrii\\Desktop\\Работа\\ОТЧЕТЫ\\Уч 10-8\\Заправки и сливы 10-8.xlsm")
...
xl.Application.Run("importdata137") # добавить проверку на существование листа и удалять его если существует
